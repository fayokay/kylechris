...
jQuery(function($) {
    'use strict';
    $('form#wrapped')['attr']('action', 'form.php');
    $('#wizard_container')['wizard']({
        ...
        beforeSelect: function(_0xb44ax4, _0xb44ax5) {
            ...
            var _0xb44ax6 = $(this)['wizard']('state')['step']['find'](':input');
    ...
    $('#wizard_container')['wizard']({
        afterSelect: function(_0xb44ax4, _0xb44ax5) {
            $('#progressbar')['progressbar']('value', _0xb44ax5['percentComplete']);
            $('#location')['text']('(' + _0xb44ax5['stepsComplete'] + '/' + _0xb44ax5['stepsPossible'] + ')')
        }
    });
    $('#wrapped')['validate']({
        ignore: [],
